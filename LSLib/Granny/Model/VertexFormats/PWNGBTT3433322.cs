...
namespace LSLib.Granny.Model.VertexFormats
{
    ...
    internal class PWNGBTT3433322_Prototype
    {
    ...
    [VertexPrototype(Prototype = typeof(PWNGBTT3433322_Prototype)),
    VertexDescription(Position = true, BoneWeights = true, BoneIndices = true, Normal = true, Tangent = true, Binormal = true, TextureCoordinates = 2)]
    public class PWNGBTT3433322 : Vertex
    {
        public override List<String> ComponentNames()
        {
            return new List<String> { "Position", "BoneWeights", "BoneIndices", "Normal", "Tangent", "Binormal", "MaxChannel_1", "MaxChannel_2" };
        }
